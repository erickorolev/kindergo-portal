...
{
    /**
     * The Application Errors defined by Realty system
     * Realty reserves the error codes 000000 - 099999 for itself.
     *
     * Do not manually change this file, as this will be changed occasionally by Realty.
     * If you do like to create your own (custom) error codes, please use the
     * CustomErrorCodesTable class and follow the scheme defined in this class here
     */
