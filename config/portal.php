...
return [
    ...
    */
    ...
    'logging' => [
        ...
        /*
        |--------------------------------------------------------------------------
        | Log Realty Wrong Caller Style
        |--------------------------------------------------------------------------
        |
        | This option describes, if a "wrong" Realty Call Style should be logged.
        | The preferred style is Realty::call('Container@Action/Task'), however,
        | one may use Realty::call(Your\Full\Classname::class) as well.
        |
